...
CREATE TABLE UserXHotels(Id UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),UserId UNIQUEIDENTIFIER ,HotelId UNIQUEIDENTIFIER,FOREIGN KEY(UserId)  REFERENCES Users,FOREIGN KEY(HotelId) REFERENCES Hotels);
...
CREATE TABLE TypesOfDays(Id UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),HotelId UNIQUEIDENTIFIER, Name NVARCHAR(50), Type int);
